...
const studiesArray = [
  {
    ...
    description:
      "My first contact with code, where I learned fundamental concepts as well as basic Unity knowledge and how to design a game from scratch.",
  ...
  },
  {
    ...
    date: "May - July 2022",
    description:
      "I was able to explore both backend and frontend sides of webdev and use actual technologies like Angular and Postman.",
  ...
  },
  {
    ...
    description:
      "Started a CS degree in September 2022 to form myself as a software engineer and learn more deep concepts about programming.",
...
const coursesArray = [
  {
    ...
    description:
      "Foundations helped me to expand my knowledge of the tools used in frontend development by providing several projects with a lot of educational value.",
  ...
  },
  {
    ...
    description:
      "Things started to fire up in this course! Learned really useful stuff like React, NodeJS and some CSS tricks to make things look smoother.",
...
function App() {
  ...
  //TODO: this may be the solution to scrolling through the page and changing title
  ...
  return (
    <>
      <div className="w-screen h-screen font-poppins flex-col items-center overflow-x-hidden scroll-smooth">
        ...
        <Hero hover={onHover}></Hero>
        <AboutMe hover={onHover}></AboutMe>
        <SoftSkills array={softSkillsArray} hover={onHover}></SoftSkills>
        <Tools array={toolsArray} hover={onHover}></Tools>
        <Studies array={studiesArray} hover={onHover}></Studies>
        <Courses array={coursesArray} hover={onHover}></Courses>
        <Portfolio hover={onHover}></Portfolio>
        <Footer></Footer>
      </div>
    </>
  );
