...
const Hero = () => {
  return (
    <section
      id="Home"
      className="h-screen flex justify-evenly items-center bg-cover px-10"
    >
      <div className="w-1/3 text-white text-2xl text-left animate-fade-right">
        <h1 className="font-semibold text-5xl mb-8">Jorge Carrasco</h1>
      ...
      <img
        className="max-h-96 border-yellow-400 border-[10px] rounded-full animate-fade-left"
        src={heroImg}
      ></img>
      <img className="absolute h-full w-full -z-10" src={bgImg}></img>
    </section>
  );
};
